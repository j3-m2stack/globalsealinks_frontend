...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-800 via-green-700 to-emerald-600 text-green-200">
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div >
              ...
              <Image
                ...
                width={320}
                height={180}
                className="h-32 md:h-52 w-auto object-contain -mt-10" priority
              />
